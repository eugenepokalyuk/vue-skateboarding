<template>
    <div>
        <div class="flex flex-col">
            <div class="sm:text-center grid grid-cols-1 md:grid-cols-2 min-h-[400px] mt-4 md:mt-0">
                <div class="relative flex items-center justify-center px-[60px]">
                    <h2
                ...
                <div class="flex flex-col items-start justify-center px-[60px]">
